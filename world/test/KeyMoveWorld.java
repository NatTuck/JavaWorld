 ...
 *                                                                       *
 *   FILE: ./world/test/KeyMoveWorld.java                                *
 *                                                                       *
...
public class KeyMoveWorld extends World{
    ...
    public KeyMoveWorld onKey(String ke){
        if(ke.equals("up"))return this.move(0,-10);
        else if(ke.equals("down"))return this.move(0, 10);
        else if(ke.equals("left"))return this.move(-10, 0);
        else if(ke.equals("right"))return this.move(10, 0);
        else if(ke.equals(" ")){
