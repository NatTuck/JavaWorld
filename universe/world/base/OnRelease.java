 ...
 *                                                                       *
 *   FILE: ./universe/world/base/OnRelease.java                          *
 *                                                                       *
 ...
 *    (World + Messages) when a Key is <i>released</i>. */
public interface OnRelease<Msg extends Serializable>{
    /** Apply this function to produce a Package (World + Messages)
     *    when a Key is released. */
    public Package<Msg> apply(World<Msg> w, String ke);
}
