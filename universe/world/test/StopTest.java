 ...
 *                                                                       *
 *   FILE: ./universe/world/test/StopTest.java                           *
 *                                                                       *
...
import image.*;
import universe.world.VoidWorld;
import universe.VoidPackage;

/** Simple Test of World/display for documentation */
public class StopTest{
    
    public static class MousePointsWorld extends VoidWorld<String>{
        ...
        public VoidPackage<String> onMouse(int x, int y, String me){
            ...
            return new VoidPackage<String>();
        }
        public boolean stopWhen(){ return this.done < 0; }
        public VoidPackage<String> onKey(String me){
